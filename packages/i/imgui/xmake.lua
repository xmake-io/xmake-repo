package("imgui")
    ...
    add_urls("https://github.com/ocornut/imgui/archive/refs/tags/$(version).tar.gz", {version = function (version) return version:gsub("%+", "") end})
    add_urls("https://github.com/ocornut/imgui.git", {alias = "git"})

    -- don't forget to add the docking versions as well
    add_versions("v1.92.9+b", "21d8a0a565e85dce943e375db00812c2f3f0ab21f3f0f7964e364a63422d7f99")
    ...
    add_versions("v1.92.9+b-docking", "90ded916bd57db2e0e171b6b098940a47c6f5042725dcdc67fb19940ca8bfdcc")
