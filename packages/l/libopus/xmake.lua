package("libopus")
    ...
    add_configs("avxSupported", { description = "AVX supported", default = true, type = "boolean" })
    add_configs("opusx86MayHaveAvx", { description = "Does runtime check for AVX support", default = true, type = "boolean" })
