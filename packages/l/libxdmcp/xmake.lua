package("libxdmcp")
    ...
    set_urls("https://www.x.org/archive/individual/lib/libXdmcp-$(version).tar.gz", {alias = "xorg"})
    set_urls("https://www.rro.rs/gentoo-distfiles/distfiles/25/libXdmcp-$(version).tar.xz", {alias = "mirror"})
