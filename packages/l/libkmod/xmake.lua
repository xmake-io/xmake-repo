package("libkmod")
    ...
    add_urls("https://github.com/kmod-project/kmod/archive/refs/tags/v$(version).tar.gz", {alias = "tarball"})
    add_urls("https://github.com/kmod-project/kmod.git", {alias = "git"})

    add_versions("git:33", "v33")
    add_versions("git:32", "v32")
    add_versions("git:31", "v31")
    add_versions("git:30", "v30")
    add_versions("tarball:33", "c72120a2582ae240221671ddc1aa53ee522764806f50f8bf1522bbf055679985")
    add_versions("tarball:32", "9477fa096acfcddaa56c74b988045ad94ee0bac22e0c1caa84ba1b7d408da76e")
    add_versions("tarball:31", "16c40aaa50fc953035b4811b29ce3182f220e95f3c9e5eacb4b07b1abf85f003")
    add_versions("tarball:30", "1fa3974abd80b992d61324bcc04fa65ea96cfe2e9e1150f48394833030c4b583")
