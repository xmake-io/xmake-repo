package("libkmod")
    ...
    add_configs("zstd",    {description = "Enable Zstandard-compressed modules support.", default = false, type = "boolean"})
    add_configs("zlib",    {description = "Enable gzipped modules support.", default = false, type = "boolean"})
    add_configs("xz",      {description = "Enable Xz-compressed modules support.", default = false, type = "boolean"})
    add_configs("openssl", {description = "Enable PKCS7 signatures support", default = false, values = {false, "openssl", "openssl3"}})
