...
add_requires("pseudo-double-c", {configs = {shared = get_config("kind"), pseudo_double_exp_bits = get_config("pseudo_double_exp_bits"), pd_error_check = get_config("pd_error_check")}})
