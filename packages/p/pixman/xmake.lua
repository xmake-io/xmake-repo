package("pixman")
    ...
    add_urls("https://gitlab.freedesktop.org/pixman/pixman/-/archive/pixman-$(version)/pixman-pixman-$(version).tar.gz")
    add_urls("https://github.com/freedesktop/pixman/archive/refs/tags/pixman-$(version).tar.gz")
    ...
    add_versions("0.42.0", "45c6462f6d6441923d4c17d06fa50ce066f0ceff0fc84af8d342df63c1079151")
