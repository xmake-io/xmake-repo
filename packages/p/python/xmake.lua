package("python")
    ...
    if is_host("windows") then
        if is_arch("x86", "i386") or os.arch() == "x86" then
            ...
            add_versions("3.11.9", "2337068c1b320dc9692c4867ae25435f79b9d5855d467bffa7d5c7f8c21535a9")
            ...
            add_versions("3.13.12", "457b41e1d630b4dca0916aa12e77991a2e2e9f8be85917bfcd39b41723ffc573")
            add_versions("3.14.3", "12bb9251a2aa9800ce27f3af25056e04bc7b356033c5fcee2b6de86206d97751")
        elseif is_arch("x64", "x86_64") or os.arch() == "x64" then
            ...
            add_versions("3.11.9", "ff8b748fb2a0a0e0bdab521f6164ea452fa2adc41db3c0962c325a4ef1f6f485")
            ...
            add_versions("3.13.12", "927a81a2fe9c3c494591498f7fe83cb97c7a3ad9b602e33e73308b332fd03967")
            add_versions("3.14.3", "d5cee33688f433285199b01a7cca91b2fb09cc38a25a7c92bc045eb2441d9fff")
        elseif is_arch("arm64.*", "aarch64") or os.arch() == "arm64" then
            ...
            add_versions("3.11.9", "aac50091bc0cf97fa2e5882ec79ab94a42c5345f01e8802b10783ddf4d2ce81e")
            ...
            add_versions("3.13.12", "ec5553e711a9883b05a82a6330ddb6755c924eda5962e6b0ced5dbeb9d448de6")
            add_versions("3.14.3", "4be66ea1b51c10f234d3e517219421648cd943764ab18e6372a019be0d4f86d9")
        end
        ...
        add_versions("3.13.12", "12e7cb170ad2d1a69aee96a1cc7fc8de5b1e97a2bdac51683a3db016ec9a2996")
        add_versions("3.14.3", "d7fe130d0501ae047ca318fa92aa642603ab6f217901015a1df6ce650d5470cd")
    end
    ...
    on_install("@macosx", "@bsd", "@linux", function (package)
        ...
        if openssl then
            -- Try to use --with-openssl for standard installs (prefix/include, prefix/lib layout)
            -- For non-standard layouts (e.g. Nix), fall back to manual CPPFLAGS/LDFLAGS
            local openssl_dir
