package("gn")
    ...
    local revision = {["20201128"] = "e55664a01f6ee92762210d0c01b13552f8117e11"}
    if is_host("windows") then
        if os.arch() == "x64" then
            add_urls("https://github.com/xmake-mirror/gn-releases/raw/v$(version)/gn-windows-amd64.zip")
            add_urls("https://chrome-infra-packages.appspot.com/dl/gn/gn/windows-amd64/+/git_revision:$(version)", {version = function (version) return revision[version] end})
    ...
    elseif is_host("linux") then
        ...
        add_urls("https://chrome-infra-packages.appspot.com/dl/gn/gn/linux-amd64/+/git_revision:$(version)", {version = function (version) return revision[version] end})
    ...
    elseif is_host("macosx") then
        if os.arch() == "arm64" then
            ...
            add_urls("https://chrome-infra-packages.appspot.com/dl/gn/gn/mac-arm64/+/git_revision:$(version)", {version = function (version) return revision[version] end})
            ...
            add_urls("https://chrome-infra-packages.appspot.com/dl/gn/gn/mac-amd64/+/git_revision:$(version)", {version = function (version) return revision[version] end})
