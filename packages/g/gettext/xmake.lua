package("gettext")
    ...
    set_urls("https://mirror.bahnhof.net/pub/gnu/gettext/gettext-$(version).tar.gz",
    ...
    add_versions("0.24", "c918503d593d70daf4844d175a13d816afacb667c06fba1ec9dcd5002c1518b7")
