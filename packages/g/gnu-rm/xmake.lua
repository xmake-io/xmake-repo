package("gnu-rm")
    ...
    if is_host("windows") then
        ...
        set_urls("https://developer.arm.com/-/media/Files/downloads/gnu-rm/$(version)/gcc-arm-none-eabi-$(version)-win32.zip")
    ...
    elseif is_host("linux") then
        if os.arch() == "arm64" then
            ...
            set_urls("https://developer.arm.com/-/media/Files/downloads/gnu-rm/$(version)/gcc-arm-none-eabi-$(version)-aarch64-linux.tar.bz2")
            ...
            set_urls("https://developer.arm.com/-/media/Files/downloads/gnu-rm/$(version)/gcc-arm-none-eabi-$(version)-x86_64-linux.tar.bz2")
    ...
    elseif is_host("macosx") then
        ...
        set_urls("https://developer.arm.com/-/media/Files/downloads/gnu-rm/$(version)/gcc-arm-none-eabi-$(version)-mac.tar.bz2")
