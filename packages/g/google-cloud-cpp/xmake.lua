package("google-cloud-cpp")
    ...
    -- Enable google_cloud_cpp_common by default
    add_configs("libraries", {description = "Enable subset of the libraries", default = {}, type = "table"})
    ...
    on_load(function (package)
        ...
        if libraries and #libraries ~= 0 then
            ...
            -- TODO: optional deps opentelemetry
            ...
            if hash_libraries:has("opentelemetry") then
                package:add("deps", "opentelemetry")
            end
        end
    end)
