package("aui")
    ...
    add_patches("v7.1.2", "patches/v7.1.2/debundle-json-network.diff", "73fff6d6a25de83ed4b5fde70ecd0977122ff732ffd863748316522e229fad9e")
    add_patches("v7.1.2", "patches/v7.1.2/debundle-main.diff", "5052d63ebe183082848dfa0c3e18bdb0b02f80db04009954d89cd6164e0ae939")
    ...
    add_patches("v7.1.2", "patches/v7.1.2/debundle-views.diff", "d9cbc994214423f3cfd59e36377f963ac300c1d06390481c3a960a985733a06f")
