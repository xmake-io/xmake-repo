package("aui")
    ...
    add_patches("v7.1.2", "patches/v7.1.2/debundle-crypt.diff", "61f8a476382129b6f84689f8dcf7e1c5dcc09931f132fab9fa2f2461fb5c54c1")
    ...
    add_patches("v7.1.2", "patches/v7.1.2/debundle-views.diff", "1b23facfaf370d6d6ba0a491c76d6444e1adead6f4601002284250f25d24d08a")
