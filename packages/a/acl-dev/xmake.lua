...
"-D_WINSOCK_DEPRECATED_NO_WARNINGS"]], {plain = true})
                    ...
                    os.mkdir("cmake")
                    os.cp(path.join(package:scriptdir(), "port", "cmakeasm_armasminformation.cmake"), "cmake/CMakeASM_ARMASMInformation.cmake")
                    os.cp(path.join(package:scriptdir(), "port", "cmakedetermineasm_armasmcompiler.cmake"), "cmake/CMakeDetermineASM_ARMASMCompiler.cmake")
                    os.cp(path.join(package:scriptdir(), "port", "cmaketestasm_armasmcompiler.cmake"), "cmake/CMakeTestASM_ARMASMCompiler.cmake")
...
include(cmake/CMakeASM_ARMASMInformation.cmake)
include(cmake/CMakeDetermineASM_ARMASMCompiler.cmake)
include(cmake/CMakeTestASM_ARMASMCompiler.cmake)]], {plain = true})
