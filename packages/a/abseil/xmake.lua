package("abseil")
    ...
    add_patches("20230802.1", path.join(os.scriptdir(), "patches", "20230802.1-0001-fix-mingw.patch"), "944926ecc0153c2465954e7bb54513cce9d16d2f91847204e89c28be7e2a8c0e")
