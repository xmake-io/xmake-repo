package("rpm")
    ...
    on_install("linux", function (package)
        ...
        io.replace("CMakeLists.txt", "PkgConfig::LIBARCHIVE", "PkgConfig::LIBARCHIVE z lzma bz2 zstd lz4", {plain = true})
        ...
        import("package.tools.cmake").install(package, configs, {jobs = 1, packagedeps = {"elfutils", "lzma", "zstd", "bzip2", "lz4", "zlib", "popt"}})
    end)
