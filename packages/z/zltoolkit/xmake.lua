package("zltoolkit")
    ...
    on_install("linux", "windows", "macosx", function (package)
        ...
        io.replace("CMakeLists.txt", "set(INSTALL_PATH_LIB $ENV{HOME}/${PROJECT_NAME}/lib)", "lib", {plain = true})
        io.replace("CMakeLists.txt", "set(INSTALL_PATH_INCLUDE $ENV{HOME}/${PROJECT_NAME}/include)", "include", {plain = true})
