package("zmqpb")
    ...
    add_versions("0.10", "1058abae523b7844e227322c9d69f3b23dd3163ea8eaf7f4b4cf3ed6e4705b13")
    ...
    on_load("windows", "macosx", "linux", function (package)
        ...
        if not package:gitref() and package:version():lt("0.10") then
            -- protobuf needed it and somehow just didn't publicizes the linkage
            package:add("deps", "utf8_range")
        end
        if package:gitref() or package:version():gt("0.9") then
