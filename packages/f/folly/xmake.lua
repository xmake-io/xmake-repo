package("folly")
    ...
    add_patches("<=2023.11.20", path.join(os.scriptdir(), "patches", "2021.06.28", "reorder.patch"), "9a6bf283881580474040cfc7a8e89d461d68b89bae5583d89fff0a3198739980")
    ...
    add_patches("<=2023.11.20", path.join(os.scriptdir(), "patches", "2023.11.20", "msvc.patch"), "ccdafe3579dd41414f60b8ad36fd071ce08bd5cf73f27d47c3717679ca3f6568")
