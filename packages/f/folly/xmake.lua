package("folly")
    ...
    add_versions("2024.10.14", "c16a4dff8d181cc01f9eb1ee2de2017ecd56dfef40bc64e0d1a9b9defdfb8723")
    ...
    add_patches("<=2024.10.14", path.join(os.scriptdir(), "patches", "2023.11.20", "pkgconfig.patch"), "6838623d453418569853f62ad97c729e802a120c13d804aabba6d6455997e674")
    add_patches("<=2024.10.14", path.join(os.scriptdir(), "patches", "2023.11.20", "msvc.patch"), "1ee01c75528bd42736541022af461e44af3031c01d62c9342006f0abc0f44f2d")
