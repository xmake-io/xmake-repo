package("folly")
    ...
    add_versions("2024.02.19", "3a1c565cefe878cee6cfa1fd6b05104498f6dbc9833fa86fa1c49f8b52e88c97")
    ...
    add_patches("<=2024.02.19", path.join(os.scriptdir(), "patches", "2023.11.20", "pkgconfig.patch"), "6838623d453418569853f62ad97c729e802a120c13d804aabba6d6455997e674")
    add_patches("<=2024.02.19", path.join(os.scriptdir(), "patches", "2023.11.20", "msvc.patch"), "1ee01c75528bd42736541022af461e44af3031c01d62c9342006f0abc0f44f2d")
    ...
    add_deps("double-conversion", "gflags", "glog", "zlib", "fmt", "snappy", "libsodium")
