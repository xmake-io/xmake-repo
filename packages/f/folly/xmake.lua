package("folly")
    ...
    add_versions("2025.03.31", "fb8657c113432f2fd2d4aaeccbedaa6890da0cd0598ed9b9d2002073afc5b9cc")
    ...
    add_patches("<=2025.03.31", path.join(os.scriptdir(), "patches", "2023.11.20", "pkgconfig.patch"), "6838623d453418569853f62ad97c729e802a120c13d804aabba6d6455997e674")
    add_patches("<=2025.03.31", path.join(os.scriptdir(), "patches", "2023.11.20", "msvc.patch"), "1ee01c75528bd42736541022af461e44af3031c01d62c9342006f0abc0f44f2d")
