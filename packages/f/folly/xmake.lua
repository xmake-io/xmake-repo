package("folly")
    ...
    add_versions("2024.07.22", "a551e899c2c8e9b73d303409d55e73a401ed261515f184014a4166bc993303db")
    ...
    add_patches("<=2024.07.22", path.join(os.scriptdir(), "patches", "2023.11.20", "pkgconfig.patch"), "6838623d453418569853f62ad97c729e802a120c13d804aabba6d6455997e674")
    add_patches("<=2024.07.22", path.join(os.scriptdir(), "patches", "2023.11.20", "msvc.patch"), "1ee01c75528bd42736541022af461e44af3031c01d62c9342006f0abc0f44f2d")
