package("freeimage")
    ...
    set_license("GPL-2.0", "GPL-3.0", "FreeImage Public License")
    ...
    add_deps("jxrlib", "libjpeg", "libpng", "libraw <0.20", "libtiff", "openexr <3.0", "openjpeg", "zlib")
    ...
    on_install("windows|x64", "windows|x86", "macosx", "linux", function (package)
        ...
        io.writefile("xmake.lua", [[
            ...
            add_requires("jxrlib", "libjpeg", "libpng", "libraw", "libtiff", "libwebp", "openexr", "openjpeg", "zlib")
            ...
            target("freeimage")
                ...
                add_packages("jxrlib", "libjpeg", "libpng", "libraw", "libtiff", "libwebp", "openexr", "openjpeg", "zlib")
