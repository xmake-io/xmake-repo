package("fontconfig")
    ...
    set_urls("https://www.freedesktop.org/software/fontconfig/release/fontconfig-$(version).tar.xz", {alias = "xz"})
    ...
    add_versions("xz:2.16.0", "6a33dc555cc9ba8b10caf7695878ef134eeb36d0af366041f639b1da9b6ed220")
    ...
    on_load("windows", "linux", "macosx", function (package)
        ...
        if package:config("nls") and package:is_plat("macosx") then
            package:add("deps", "gettext")
        end
