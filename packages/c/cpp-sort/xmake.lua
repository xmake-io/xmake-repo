package("cpp-sort")
    ...
    set_description("Sorting algorithms & related tools for C++")
    set_license("MIT")

    add_urls("https://github.com/Morwenn/cpp-sort/archive/refs/tags/$(version).tar.gz", {version = function(version)
        if version:ge("2.0.0") then
            version = "v" .. version
        end
        return version
    end})
    add_urls("https://github.com/Morwenn/cpp-sort.git", {alias = "git"})
    ...
    add_versions("1.17.2", "76708698aa22f605e2d16c5e927b4c3a88cf4b32df31467d2f036025c0178e82")
    add_versions("2.1.0", "b86af13cb265cff5c47c6a064a5b537c754d5abdcd663064f62d358df43c789c")

    add_versions("git:1.10.0", "1.10.0")
    add_versions("git:1.11.0", "1.11.0")
    add_versions("git:1.12.0", "1.12.0")
    add_versions("git:1.12.1", "1.12.1")
    add_versions("git:1.13.0", "1.13.0")
    add_versions("git:1.13.1", "1.13.1")
    add_versions("git:1.13.2", "1.13.2")
    add_versions("git:1.14.0", "1.14.0")
    add_versions("git:1.15.0", "1.15.0")
    add_versions("git:1.16.0", "1.16.0")
    add_versions("git:1.17.0", "1.17.0")
    add_versions("git:1.17.1", "1.17.1")
    add_versions("git:1.17.2", "1.17.2")
    add_versions("git:2.1.0", "v2.1.0")
    ...
    on_test(function (package)
        local languages = package:version():ge("2.0.0") and "c++20" or "c++14"
