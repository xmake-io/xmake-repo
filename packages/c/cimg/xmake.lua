package("cimg")
    ...
    add_versions("v4.0.4", "bfd21899ab14925fec36b9b398ddfbe34d52f3851a453dabf349857655addc10")
    add_versions("v3.7.5", "18ad7f70dfbfd3a1ce968dec0c29eeafcaecc9570e5e59565055c2d40fddeb98")
    add_versions("v3.7.4", "0dc1cb9cd35420b165fd2a0cb73967fdb1f0d4f328e58d0ef3a719c2a45e1a3f")
    ...
    add_versions("git:v4.0.4", "v.4.0.4")
    add_versions("git:v3.7.5", "v.3.7.5")
    add_versions("git:v3.7.4", "v.3.7.4")
