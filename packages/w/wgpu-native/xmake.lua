package("wgpu-native")
    ...
    elseif is_plat("windows") and is_arch("x86") then
        ...
        add_urls("https://github.com/gfx-rs/wgpu-native/releases/download/$(version)/wgpu-windows-i686-msvc-release.zip", {version = function(version) return version:gsub("%+", ".") end})
    ...
    elseif is_plat("linux") and is_arch("arm64-v8a") then
        add_urls("https://github.com/gfx-rs/wgpu-native/releases/download/$(version)/wgpu-linux-x86_64-release.zip", {version = function(version) return version:gsub("%+", ".") end})
        add_urls("https://github.com/gfx-rs/wgpu-native/releases/download/$(version)/wgpu-linux-aarch64-release.zip", {version = function(version) return version:gsub("%+", ".") end})
