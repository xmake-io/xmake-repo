package("wayland")
    ...
    add_versions("1.22.0", "1540af1ea698a471c2d8e9d288332c7e0fd360c8f1d12936ebb7e7cbc2425842")
    ...
    add_resources("1.22.0", "protocols", "https://gitlab.freedesktop.org/wayland/wayland-protocols/-/releases/1.31/downloads/wayland-protocols-1.31.tar.xz", "a07fa722ed87676ec020d867714bc9a2f24c464da73912f39706eeef5219e238")
