package("sqlitecpp")
    ...
    on_install(function (package)
        ...
        if is_plat("windows") then
            ...
            table.insert(configs, "-DSQLITECPP_USE_STATIC_RUNTIME=" .. ((package:config("runtimes") and package:has_runtime("MT", "MTd")) or (package:config("vs_config") and package:config("vs_config"):startswith("MT")) and "ON" or "OFF"))
        end
