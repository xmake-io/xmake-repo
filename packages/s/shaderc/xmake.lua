package("shaderc")
    ...
    on_install("linux", "windows", "macosx", function (package)
        ...
        if package:is_plat("windows") then
            table.insert(configs, "-DSHADERC_ENABLE_SHARED_CRT=" .. ((package:config("runtimes") and package:has_runtime("MT", "MTd")) or (package:config("vs_config") and package:config("vs_config"):startswith("MT")) and "OFF" or "ON"))
        end
