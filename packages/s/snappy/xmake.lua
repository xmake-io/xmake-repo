package("snappy")
    ...
    add_patches("1.2.1", "patches/1.2.1/0001-Update-CMakeLists-NEON-flag-to-reflect-only-AArch64-.patch", "13100aa56de71a11bb3704bd7507613fd53caa3ab6e7dbec3de74875deb46ba5")
