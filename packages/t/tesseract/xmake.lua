package("tesseract")
    ...
    on_install("windows|x86", "windows|x64", "macosx", "linux", function (package)
        ...
        if package:is_plat("windows") then
            table.insert(configs, "-DWIN32_MT_BUILD=" .. ((package:config("runtimes") and package:has_runtime("MT", "MTd")) or (package:config("vs_config") and package:config("vs_config"):startswith("MT")) and "ON" or "OFF"))
        end
