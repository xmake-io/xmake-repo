package("tracy")
    ...
    add_configs("callstack",                        {type = "boolean", default = false, description = "Disable all callstack related functionality"})
    add_configs("callstack_inlines",                {type = "boolean", default = false, description = "Disables the inline functions in callstacks"})
    add_configs("only_localhost",                   {type = "boolean", default = false, description = "Only listen on the localhost interface"})
    add_configs("broadcast",                        {type = "boolean", default = false, description = "Disable client discovery by broadcast to local network"})
    ...
    add_configs("code_transfer",                    {type = "boolean", default = false, description = "Disable collection of source code"})
    add_configs("context_switch",                   {type = "boolean", default = false, description = "Disable capture of context switches"})
    ...
    add_configs("sampling",                         {type = "boolean", default = false, description = "Disable call stack sampling"})
    add_configs("verify",                           {type = "boolean", default = false, description = "Disable zone validation for C API"})
    add_configs("vsync_capture",                    {type = "boolean", default = false, description = "Disable capture of hardware Vsync events"})
    add_configs("frame_image",                      {type = "boolean", default = false, description = "Disable the frame image support and its thread"})
    add_configs("system_tracing",                   {type = "boolean", default = false, description = "Disable systrace sampling"})
    ...
    add_configs("crash_handler",                    {type = "boolean", default = false, description = "Disable crash handling"})
