package("ndk")
    ...
    if is_host("windows") then
        ...
        add_versions("22", "5a0eafa83c8bba3c76e8427aa3d83d169215f62963a277b1914a3651aa47f751")
    elseif is_host("linux") then
        ...
        add_versions("22", "d37fc69cd81e5660234a686e20adef39bc0244086e4d66525a40af771c020718")
    elseif is_host("macosx") then
        ...
        add_versions("22", "14fce4dea7fb3facbc0e3d20270007bffec3ba383aec02e8b0e0dad8d8782892")
    end
