package("ninja")
    ...
    if is_host("windows") then
        if os.arch() == "arm64" then
            ...
            add_versions("v1.13.2", "e52f0bdef9dfb1003229dbd6508a508c4073fd017247002adc66e5e806cb0391")
        else
            ...
            add_versions("v1.13.2", "07fc8261b42b20e71d1720b39068c2e14ffcee6396b76fb7a795fb460b78dc65")
        end
    elseif is_host("macosx") then
        ...
        add_versions("v1.13.2", "c99048673aa765960a99cf10c6ddb9f1fad506099ff0a0e137ad8960a88f321b")
    elseif is_host("linux", "bsd") then
        ...
        add_versions("v1.13.2", "974d6b2f4eeefa25625d34da3cb36bdcebe7fbce40f4c16ac0835fd1c0cbae17")
    end
