package("directxshadercompiler")
    ...
    if is_plat("windows") then 
        ...
        add_versions("1.8.2403", "500332ff6e6f2739910239937016d4e9cccdc0d2251a33a94e366bdf18c1d5fd")
    elseif is_plat("linux") and is_arch("x86_64") then 
        ...
        add_versions("v1.8.2403", "f01620321135de7c74359c5e3560279d20b47e65cc2e671c4409c929c699b96c")
