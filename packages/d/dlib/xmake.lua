package("dlib")
    ...
    on_install(function (package)
        ...
        table.insert(configs, "-DDLIB_LINK_WITH_SQLITE3=" .. (package:config("blas") and "ON" or "OFF"))
        table.insert(configs, "-DDLIB_LINK_WITH_SQLITE3=" .. (package:config("mkl") and "ON" or "OFF"))
