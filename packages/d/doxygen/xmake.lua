package("doxygen")
    ...
    add_versions("github:1.16.1", "Release_1_16_1")
    add_versions("github:1.16.0", "Release_1_16_0")
    add_versions("github:1.15.0", "Release_1_15_0")
    add_versions("github:1.14.0", "Release_1_14_0")
    add_versions("github:1.13.2", "Release_1_13_2")
    add_versions("github:1.13.1", "Release_1_13_1")
    add_versions("github:1.13.0", "Release_1_13_0")
    add_versions("github:1.12.0", "Release_1_12_0")
    add_versions("github:1.11.0", "Release_1_11_0")
    ...
    if not is_plat("windows") then
        add_deps("cmake", "bison >=2.7", "flex", "libiconv", {private = true})
        add_deps("python 3.x", {kind = "binary", private = true})
    end

    on_load("@windows", function (package)
        if package:is_built() then
            package:add("deps", "cmake", "bison >=2.7", "flex", "libiconv")
