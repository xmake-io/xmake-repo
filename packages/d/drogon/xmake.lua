package("drogon")
    ...
    add_patches("1.8.0",   path.join(os.scriptdir(), "patches", "1.8.0", "redis.patch" ), "d164c38ba2fbdec683c64fbd58b719cf550e8629a58b8fb22823ccb0ce549c40")
    add_patches(">=1.8.0", path.join(os.scriptdir(), "patches", "1.8.0", "resolv.patch"), "7767c1c3e85baaa941a3738dba11d62125bd7e4eb203f507af5efd87e5177ac1")
    add_patches(">=1.8.0", path.join(os.scriptdir(), "patches", "1.8.0", "config.patch"), "b1c75ae27353bb20c7dbab1be9f8f90718fc707e7745ad0f2a4346b66dfb986d")
