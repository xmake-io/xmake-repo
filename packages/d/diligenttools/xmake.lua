package("diligenttools")
    ...
    add_patches("v2.5.6", "patches/v2.5.6/build.diff", "da0dc0261bb0067501231fb8410208a6c8ef190fefc8c265c6379014fe47021d")
    ...
    add_deps("diligentcore",
             "libpng", "libtiff", "zlib", "libjpeg",
             "taywee_args", "nlohmann_json", "stb", "tinygltf")
