package("joltphysics")
    ...
    -- patch for attribute order (fixes compilation in shared mode)
    add_patches("v4.0.0", "https://github.com/jrouwe/JoltPhysics/commit/759ade2d471ba6baf960761cc7bd34938c2284a8.patch")
