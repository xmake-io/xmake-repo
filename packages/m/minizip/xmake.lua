package("minizip")
    ...
    local versionCheck = xmake:version():lt("3.0.4")
    on_install(function (package)
        ...
        if package:config("cmake") then
            ...
            if versionCheck and package:is_plat("cross") and package:check_sizeof("void*") == "4" and os.exists(config_version_file) then
