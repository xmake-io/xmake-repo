package("mapbox_geometry")
    ...
    add_patches("1.1.0", path.join(os.scriptdir(), "patches", "1.1.0", "pragma.patch"), "ae1322528bcacafb9250ef6574d8780aa69cf6f1f45c941a0494ed0ee66bd7c8")
    add_patches("2.0.3", path.join(os.scriptdir(), "patches", "1.1.0", "pragma.patch"), "ae1322528bcacafb9250ef6574d8780aa69cf6f1f45c941a0494ed0ee66bd7c8")
