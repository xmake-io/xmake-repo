package("mkl")
    ...
    if is_plat("windows") then
        if is_arch("x64") then
            ...
            add_resources("2024.1.0+692", "6431647057cd8757a464a3f6ab2099139e059d04446f04443afd2570febe42bf")
        ...
        elseif is_arch("x86") then
            ...
            add_resources("2024.1.0+692", "7a8622f23a27fa487f08653645b6dc3f46b10f5b60ea2b90377812571730d0d9")
