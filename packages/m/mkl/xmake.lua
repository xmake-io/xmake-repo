package("mkl")
    ...
    if is_plat("windows") then
        if is_arch("x64") then
            ...
            add_resources("2021.2.0+296", "headers", "https://software.repos.intel.com/python/conda/win-64/mkl-include-2021.2.0-intel_296.tar.bz2", "ba222ea4ceb9e09976f23a3df39176148b4469b297275f3d05c1ad411b3d54c3")
            ...
            add_resources("2022.1.0+192", "headers", "https://software.repos.intel.com/python/conda/win-64/mkl-include-2022.1.0-intel_192.tar.bz2", "b6452e8c4891fcfab452bc23c6adc9c61ab6635fa494bb2b29725473c1013abc")
        ...
        elseif is_arch("x86") then
            ...
            add_resources("2021.2.0+296", "headers", "https://software.repos.intel.com/python/conda/win-32/mkl-include-2021.2.0-intel_296.tar.bz2", "8ed173edff75783426de1bbc1d122266047fc84d4cfc5a9b810b1f2792f02c37")
            ...
            add_resources("2022.0.3+171", "headers", "https://software.repos.intel.com/python/conda/win-32/mkl-include-2022.0.3-intel_171.tar.bz2", "f696cd98b2f33b2c21bf7b70f57e894a763dad1831c721a348614cfeb17a4541")
    ...
    --     add_resources("2021.2.0+269", "headers", "https://software.repos.intel.com/python/conda/osx-64/mkl-include-2021.2.0-intel_269.tar.bz2", "5215d62cadeb3f8021230163dc35ad38259e3688aa0f39d7da69ebe54ab45624")
    --     add_versions("2021.3.0+517", "85a636642ee4f76fba50d16c45099cd22082eb1f8b835a4a0b455ec4796ebf8f")
    --     add_resources("2021.3.0+517", "headers", "https://software.repos.intel.com/python/conda/osx-64/mkl-include-2021.3.0-intel_517.tar.bz2", "db9896e667b31908b398d515108433d8df95e6429ebfb9d493a463f25886019c")
    --     add_versions("2022.1.0+208", "06e5dcd7b8f11f9736d4e4d7d5a9972333ee8822cf2263ecccf4cb0e3cc95530")
    --     add_resources("2022.1.0+208", "headers", "https://software.repos.intel.com/python/conda/osx-64/mkl-include-2022.1.0-intel_208.tar.bz2", "569ea516148726b2698f17982aba2d9ec1bfb321f0180be938eddbc696addbc5")
    ...
    elseif is_plat("linux") then
        if is_arch("x86_64") then
            ...
            add_resources("2021.2.0+296", "headers", "https://software.repos.intel.com/python/conda/linux-64/mkl-include-2021.2.0-intel_296.tar.bz2", "13721fead8a3eddee15b914fd3ae9cf2095966af79bbc2f086462eda9fff4d62")
            add_versions("2021.3.0+520", "c1e21988bbf05b455077a512cb719ef59ec6e06a6807cfefb892945ec19de5d0")
            add_resources("2021.3.0+520", "headers", "https://software.repos.intel.com/python/conda/linux-64/mkl-include-2021.3.0-intel_520.tar.bz2", "b0df7fb4c2071fdec87b567913715a2e47dca05e8c3ac4e5bcf072d7804085af")
            add_versions("2022.1.0+223", "9dfb2940447cc8cf7ca3e647e2b62be714e89cbca162998cbf4e05deb69b6bd2")
            add_resources("2022.1.0+223", "headers", "https://software.repos.intel.com/python/conda/linux-64/mkl-include-2022.1.0-intel_223.tar.bz2", "704e658a9b25a200f8035f3d0a8f2e094736496a2169f87609f1cfed2e2eb0a9")
            add_versions("2023.2.0+49495", "5c91829865f36f7f5845f5b38e509bb05bee1a38ccfd2caa0eabc0c28aaa4082")
            add_resources("2023.2.0+49495", "headers", "https://software.repos.intel.com/python/conda/linux-64/mkl-include-2023.2.0-intel_49495.tar.bz2", "0dfb6ca3c17d99641f20877579c78155cf95aa0b22363bcc91b1d57df4646318")
        ...
        elseif is_arch("i386") then
            ...
            add_resources("2022.0.2+136", "headers", "https://software.repos.intel.com/python/conda/linux-32/mkl-include-2022.0.2-intel_136.tar.bz2", "16882aeddbd33a2dc9210e61c59db6ad0d7d9efdd40ad1544b369b0830683371")
