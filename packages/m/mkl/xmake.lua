package("mkl")
    ...
    if is_plat("windows") then
        if is_arch("x64") then
            ...
            add_versions("2025.0.0+928", "27b648f7420621b73b0b54394caa0facaf1c8c720748e3a9085398a48ff17e173")
    ...
    elseif is_plat("linux") then
        if is_arch("x86_64") then
            ...
            add_resources("2025.0.0+939", "headers", "https://software.repos.intel.com/python/conda/linux-64/mkl-include-2025.0.0-intel_939.tar.bz2", "e3c02344b0405d90c7b992493a081f1f763fa96493626a5da1fe7693040a486")
