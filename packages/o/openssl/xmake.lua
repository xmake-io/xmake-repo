package("openssl")
    ...
    add_patches("1.1.1-t", path.join(os.scriptdir(), "patches", "1.1.1t.diff"), "d96d33bad08afd2fd7a65999d766d5192fa55183626602b44f69d134dfc90b53")
    ...
    add_patches("1.1.1-q", path.join(os.scriptdir(), "patches", "1.1.1q.diff"), "2ad8580d53607fc3db5e1dff95d6f8173108e7dbff3c210816f26ab147c0edd5")
    add_versions("1.1.1-p", "7fe975ffe91d8343ebd021059eeea3c6b1d236c3826b3a08ef59fcbe75069f5b")
    add_patches("1.1.1-p", path.join(os.scriptdir(), "patches", "1.1.1p.diff"), "68cd19c4961ec5390b85b646c524aa268a99d17da1c74b9540ada652748518d8")
