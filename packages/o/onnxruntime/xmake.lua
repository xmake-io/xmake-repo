package("onnxruntime")
    ...
    if is_plat("windows") then
        ...
        elseif is_arch("x86") then
            ...
            add_versions("1.14.1", "bfab03c7fad893c31d67888336c8d9353333f3186140991c2b6d1f9c78a38e7b")
    ...
    elseif is_plat("linux") then
        if is_arch("x86_64") then
            ...
            add_versions("1.14.1", "010585f534d822bf02d54c7cfc53b57aa3eb0cf34f8fb7503ee519ed18e25d29")
        ...
        elseif is_arch("arm64") then
            ...
            add_versions("1.14.1", "20965e05d2da6a0e6acedda8aca1a8f75c3f4cb1d7932403a9977b753b1b2120")
    ...
    elseif is_plat("macosx") then
        if is_arch("x86_64") then
            ...
            add_versions("1.14.1", "e23fa5cd5bfc70be493e8dddf405922d8867adb72029136e50b6aa21c5967214")
        ...
        elseif is_arch("arm64") then
            ...
            add_versions("1.14.1", "ed75ab93a7950cece7f9f3b2d97507479c359a083f67772ee527c94d0e5cd83c")
    ...
    on_install("windows", "linux|arm64", "linux|x86_64", "macosx", function (package)
        ...
        io.replace(package:installdir("lib/cmake/onnxruntime/onnxruntimeTargets.cmake"), "include/onnxruntime", "include", {plain = true})
        io.replace(package:installdir("lib/cmake/onnxruntime/onnxruntimeTargets-release.cmake"), "lib64", "lib", {plain = true})
    end)
