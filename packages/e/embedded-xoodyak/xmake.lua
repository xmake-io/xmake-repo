package("embedded-xoodyak")
    ...
    add_patches("0.1.0", "patches/0.1.0/fix-msvc-asm.patch", "b3695a9fc3efae3242f219bf19adce2faf02a42c6adab6b5dcb35e55b9633e53")

    on_install(function (package)
        import("package.tools.xmake").install(package, {}, {target = "xoodyak"})
    end)
